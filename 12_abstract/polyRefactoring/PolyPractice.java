package polyRefactoring;

import java.util.Scanner;

public class PolyPractice {
	static Scanner sc = new Scanner(System.in);
	static String name[] = { "치킨", "인생떡볶이", "피자", "국물닭발", "육회", "새우튀김", "감바스", "스테이크", "메론빙수", "생맥주 500cc" };
	static boolean order[] = new boolean[name.length];
	static int cost[] = { 14000, 13000, 12000, 11000, 10000, 9000, 8000, 7000, 6000, 5000 };
